	...
	<div id="breadcrumb">
		<div class="container">	
			<div class="breadcrumb">	
			  ...
			  <li><a class="submenu" href="bestseller">Bestseller</a></li>
      ...
      <c:forEach items="${list}" var="book" varStatus="status">
        ...
        <tr class="booklist-tr cursor-p" style="color: #777777; height: 50px;" align="center" onclick="javascript:lightbox(event, ${book.bookno})">
            ...
            <td align="center" width="10%">
              <img class="bookList" src="/view?fileName=${book.title}&fileType=IMAGE&series=${book.series}&bookversion=${book.bookversion}&pageNo=thumbnail" onerror="this.src='/resources/usertemplate/images/canreadbook.png'">
            </td>
            <td align="left" style="padding-left: 20px">
                <div class="row">
                    ...
                    <div class="col-xs-3 col-md-2">
                        ...
                        <div class="row">평점 ${book.starpoint}</div>
                        <div class="row">판매량 ${book.sellcnt}</div>
                    </div>
                </div>
            </td>
        </tr>
