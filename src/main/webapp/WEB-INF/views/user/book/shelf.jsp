                ...
                <div class="navbar-collapse collapse">
                    <div class="menu">
                        <ul class="nav nav-tabs mainmenu" role="tablist">
                            ...
                            <li role="presentation"><a href="indiebook/bestseller">INDIE BOOK</a></li>
...
<div id="breadcrumb">
   <div class="container">   
      <div class="breadcrumb">                     
         ...
         <li><span class="submenu" id="submenu_all" onclick="javascript:criSettingSubmit(this)">all</span></li>
         <li><span class="submenu" id="isContinue" lang="true" onclick="javascript:criSettingSubmit(this)">continue</span></li>
         <li><span class="submenu" id="isBookMark" lang="true" onclick="javascript:criSettingSubmit(this)">bookmark</span></li>
         <li><a class="submenu bookRead" data-title="BOOKTIKER" data-remote="registerBookTiker">register</a></li>
      </div>      
   </div>   
</div>
<!--logo end-->
                ...
                <div class="col-md-8 col-xs-12">
                    <div class="col-xs-12 bookOnShelf"
                        ...
                        <c:forEach items="${list1}" var="card" varStatus="status">
                            <div class="col-xs-3" align="center">
                              <a class="bookRead" id="${card.cardno}" href="" data-title="Book information" data-remote="bookinfo?cardno=${card.cardno}">
                                <img onmouseout="javascript:downf($(this).attr('id'))" onmouseover="javascript:overf($(this).attr('id'))" id="bookss${status.count-1}" class="books" style="z-index: 101; position: absolute; margin-left:-45px;margin-top:40px; width: 90px; height: 120px;" title="${card.title}" src="/view?fileName=${card.title}&fileType=IMAGE&series=${card.series}&bookversion=${card.bookversion}&pageNo=thumbnail">
                              </a>
                            </div>
                        </c:forEach>
                    </div>
                    <div class="col-xs-12 bookOnShelf"
                        ...
                        <c:forEach items="${list2}" var="card" varStatus="status">
                            <div class="col-xs-3">
                              <a class="bookRead" id="${card.cardno}" href="" data-title="Book information" data-remote="bookinfo?cardno=${card.cardno}">
                                <img onmouseout="javascript:downf($(this).attr('id'))" onmouseover="javascript:overf($(this).attr('id'))" id="bookss${3+status.count}" class="books" style="z-index: 101; position: absolute; margin-left:-45px;margin-top:40px; width: 90px; height: 120px;" title="${card.title}" src="/view?fileName=${card.title}&fileType=IMAGE&series=${card.series}&bookversion=${card.bookversion}&pageNo=thumbnail">
                              </a>
                            </div>
                        </c:forEach>
                    </div>
                    <div class="col-xs-12 bookOnShelf"
                        ...
                        <c:forEach items="${list3}" var="card" varStatus="status">
                            <div class="col-xs-3">
                              <a class="bookRead" id="${card.cardno}" href="" data-title="Book information"  data-remote="bookinfo?cardno=${card.cardno}">
                                <img onmouseout="javascript:downf($(this).attr('id'))" onmouseover="javascript:overf($(this).attr('id'))" id="bookss${7+status.count}" class="books" style="z-index: 101; position: absolute; margin-left:-45px;margin-top:40px; width: 90px; height: 120px;" title="${card.title}" src="/view?fileName=${card.title}&fileType=IMAGE&series=${card.series}&bookversion=${card.bookversion}&pageNo=thumbnail">
                              </a>
                            </div>
                        </c:forEach>
                    </div>
...
<script>
   ...
   if($('#criteriaForm').find('input[name=isBookMark]').attr('value') == 'true'){
      ...
      $('#isBookMark').addClass('select_submenu');
   }else if($('#criteriaForm').find('input[name=isContinue]').attr('value') == 'true'){
      $('#isContinue').addClass('select_submenu');
   }else{
      $('#submenu_all').addClass('select_submenu');
   }
