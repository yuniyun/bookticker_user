...
<div id="breadcrumb">
	<div class="container">	
		<div class="breadcrumb">	
		  ...
		  <li><a class="select_submenu" href="mybook">mybook</a></li>
               ...
               <div class="col-xs-12 bookOnShelf"
                   ...
                   <c:forEach items="${list1}" var="book" varStatus="status">
                       <div class="col-xs-3" align="center">
                         <a class="bookRead" id="${book.bookno}" href="" data-title="Book information" data-remote="mybookinfo?bookno=${book.bookno}">
                           <%-- <c:choose>
...
<script>
    ...
    $('.bookRead').on('click', function(event){
       ...
       $(this).attr('href', 'mybookinfo?bookno='+bookno);
