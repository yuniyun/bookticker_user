...
<!-- Bootstrap -->
<link href="/resources/usertemplate/css/bootstrap.min.css"
	rel="stylesheet">
<link rel="stylesheet"
	href="/resources/usertemplate/css/font-awesome.min.css">
<link rel="stylesheet" href="/resources/usertemplate/css/animate.css">
<link href="/resources/usertemplate/css/prettyPhoto.css"
	rel="stylesheet">
<link href="/resources/usertemplate/css/generalstyle.css"
	rel="stylesheet" />
...
<body class="blackF">
	<form action="registerbook" method="post" enctype="multipart/form-data">
	  <div class="blackF" style="width: 100%; padding: 10px 10px 10px 10px;">
		<table width="100%">
			<tr>
				<th>카테고리</th>
				<td colspan="2">
					<select class="noborder" name="bookcategory">
			...
			<tr>
				<td colspan="3" class="whiteArea-10"></td>
			</tr>
			<tr>
				<td colspan="3" class="grayLine"></td>
			</tr>
			<tr>
				<td colspan="3" class="whiteArea-10"></td>
			</tr>
			...
			<tr>
				<th>소개문</th>
				<td colspan="2"><textarea name="overview" style="width: 100%; resize: none"
						rows="5"></textarea></td>
			</tr>
			<tr>
				<td colspan="3" class="whiteArea-10"></td>
			...
			<tr>
				<th>파일업로드</th>
				<td width="100%"><input type="file" name="upl" /></td>
			</tr>
			<tr>
				<th></th>
				<td colspan="2"><textarea
						style="width: 100%; resize: none; border: groove;" rows="5"
						readonly class="f10">[업로드시 유의사항]
  1. 문서 파일의 확장자는 'pdf'로 제한합니다.
  2. 작품 등록시 첫장에는 반드시 표지가 존재해야 합니다.
  3. 등록시 3장 분량의 원고가 있어야 합니다.
  4. 음란물, 도배성문구, 광고 등 부적절한 파일을 등록시 불이익이 있을 수 있습니다.
  5. 작품은 관리자의 승인 하에 등록되며, 승인 대기 중 수정이 불가합니다.
  6. 수정,삭제는 관리자의 승인 하에 가능하며, 추가 업로드는 자유롭습니다.
   (단, 부적절한 게시글 등록 시 경고없이 제재조치합니다.)
