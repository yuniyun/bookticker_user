        ...
        <tr>
            ...
            <td  colspan="3" width="100%" style="padding-left: 20px">
                <div class="row">
                    ...
                    <div class="col-sm-6 f12" style="text-align: right; color: #91bfe6">
                      <div class="cursor-p" >
                        <span class="f12 blueF b">+</span> <a id="addMybook" style="text-decoration: underline;">책장에 추가</a>
                      </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-6 f12 grayMF"><i class="fa fa-thumbs-o-up fa-2x" style="color: #91bfe6"></i> <b>추천</b> 12000+ | <b>즐겨찾기</b> ${book.sellcnt}</div>
