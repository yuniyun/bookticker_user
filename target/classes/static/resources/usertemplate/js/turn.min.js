...
(function (h) {
    var x, y = "", G = Math.PI, E = G / 2, q = "Touch"in window, I = q ? {
    ...
    } : {start: "mousedown", move: "mousemove", end: "mouseup"}, J = {
        backward: ["bl", "tl"],
        forward: ["br", "tr"],
        all: ["tl", "bl", "tr", "br"]
    }, O = ["single", "double"], P = {
        ...
        display: "double",
        when: null
    }, Q = {folding: null, corners: "forward", cornerSize: 100, gradients: !0, duration: 600, acceleration: !0}, K = {
        ...
        init: function (a) {
            ...
            h(this).bind(I.start, function (a) {
                for (var b in c.pages)if (p(b, c.pages) && i._eventStart.call(c.pages[b], a) === false)return false
            });
            ...
            if (a) {
                ...
                "single" == a ? b.pageObjs[0] || (this.turn("stop").css({overflow: "hidden"}),
                    b.pageObjs[0] = h("<div />", {"class": "turn-page p-temporal"}).css({
                        width: this.width(),
                        height: this.height()
                    }).appendTo(this)) : b.pageObjs[0] && (this.turn("stop").css({overflow: ""}), b.pageObjs[0].remove(), delete b.pageObjs[0]);
                b.display = a;
            ...
            if (a && b) {
                ...
                for (e in c.pageWrap)p(e, c.pageWrap) && (c.pageObjs[e].css({
                    width: d,
                    height: b
                }), c.pageWrap[e].css({width: d, height: b}), c.pages[e] && c.pages[e].css({width: d, height: b}));
                this.turn("resize");
                return this
            }
        ...
        _cornerActivated: function (a) {
            ...
            var a = q ? a.originalEvent.touches : [a], b = this.data().f, c = b.parent.offset(), d = this.width(), e = this.height(), a = {
                x: Math.max(0, a[0].pageX - c.left),
                y: Math.max(0, a[0].pageY - c.top)
            }, b = b.opts.cornerSize, c = i._cAllowed.call(this);
            if (0 >= a.x || 0 >= a.y || a.x >= d || a.y >= e)return !1;
            if (a.y < b)a.corner = "t"; else if (a.y >= e - b)a.corner = "b"; else return !1;
            if (a.x <= b)a.corner += "l"; else if (a.x >= d - b)a.corner += "r"; else return !1;
            ...
            a && (b.wrapper.css({width: e, height: e}), b.fwrapper.css({
                width: e,
                height: e
            }).children(":first-child").css({width: c, height: d}), b.fpage.css({
                width: d,
                height: c
            ...
            var o = this.data().f, w = o.opts.acceleration, y = o.wrapper.height(), q = i._c.call(this, a.corner), D = "t" == a.corner.substr(0, 1), A = "l" == a.corner.substr(1, 1), F = function () {
                ...
                var l = ["0", "auto"], v = (r - y) * e[0] / 100, q = (u - y) * e[1] / 100, c = {
                    left: l[c[0]],
                    top: l[c[1]],
                    right: l[c[2]],
                    bottom: l[c[3]]
                }, l = 90 != k && -90 != k ? A ? -1 : 1 : 0, e = e[0] + "% " + e[1] + "%";
            ...
            if (c) {
                if (b) {
                    ...
                    this.animatef({
                        from: [c.x, c.y], to: [a.x, a.y], duration: 500, frame: function (b) {
                            a.x = Math.round(b[0]);
                            a.y = Math.round(b[1]);
                            i._fold.call(g, a)
                        }
        ...
        hide: function () {
            ...
            var b = this.data().f;
            if (!b.disabled)if (a = q ? a.originalEvent.touches : [a], b.corner) {
